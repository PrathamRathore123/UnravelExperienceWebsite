          ...
          <div className="max-w-[1708px] mx-auto px-4 md:px-12">
            ...
            <div className="lg:flex  gap-6 md:gap-8 items-center">
              <div className="lg:w-[150%]">
                ...
                <Card className="mb-10 lg:mb-0 bg-white rounded-[10px] border border-[#00000026] shadow-[0px_4px_29px_#0000001a] p-6 md:px-1 md:py-8">
          ...
          <div className="  px-5">
            <div className="w-full flex flex-col-reverse md:flex-row justify-between items-center ">
              ...
              <div className="flex justify-center mb-10 md:mt-0 md:justify-end gap-2 md:gap-4 md:w-full">
                <img
                  className=" w-[30%]  lg:h-[737px] rounded-[30px_0px_0px_30px] md:rounded-[50px_0px_0px_50px] object-cover"
                  alt="Rectangle"
                  src="https://c.animaapp.com/miuhpmp5biS0W2/img/rectangle-133.png"
                />
                <img
                  className="w-[30%] h-[300px] md:h-[737px] object-cover"
                  alt="Rectangle"
                  src="https://c.animaapp.com/miuhpmp5biS0W2/img/rectangle-152.png"
                />
                <img
                  className="w-[30%] h-[300px] md:h-[737px] rounded-[0px_30px_30px_0px] md:rounded-[0px_50px_50px_0px] object-cover"
                  alt="Rectangle"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 px-5">
              <Card className="bg-white rounded-[12px] border border-[#00000026] shadow-[0px_4px_29px_#0000001a] py-5 px-12">
                <CardContent className="p-0 flex flex-col items-center text-center">
                  ...
                  <p className="[font-family:'BDO_Grotesk-Bold',Helvetica] font-bold text-black text-sm md:text-xl tracking-[-0.32px] md:leading-[34px]">
              ...
              <Card className="bg-white rounded-[12px] border border-[#00000026] shadow-[0px_4px_29px_#0000001a] py-7 px-12">
                <CardContent className="p-0 flex flex-col items-center text-center">
                  ...
                  <p className="[font-family:'BDO_Grotesk-Bold',Helvetica] font-bold text-black md:text-xl tracking-[-0.32px] md:leading-[34px]">
        ...
        <section className=" w-full py-20 bg-[#f6f3f0]">
          ...
          <div className=" flex flex-col-reverse md:flex-row justify-around items-center max-w-[1708px] mx-auto px-4 md:px-12 gap-8">
            <div className="w-full md:w-[45%]">
              ...
              <h3 className="[font-family:'BDO_Grotesk-Bold',Helvetica] font-bold text-black text-xl md:text-2xl tracking-[-0.32px] md:leading-[80px] mb-4">
