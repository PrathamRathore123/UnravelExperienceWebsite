      ...
      >
        ...
        <section className=" w-full min-h-[400px] md:h-[570px] px-4 py-8 md:py-0">
          ...
          <div className="w-full flex  flex-col lg:flex-row gap-4 lg:gap-20 lg:justify-center items-center">
            ...
            <h1 className="mr-[50%] lg:mr-0  [font-family:'BDO_Grotesk-Bold',Helvetica] font-bold text-black text-3xl md:text-[72px] tracking-[-1.92px] leading-tight md:leading-[91.2px]">
              We are
            </h1>
            <div>
              ...
              <img className=" w-[200px] h-[240px] md:w-[304px] md:h-[385px] rounded-2xl bg-cover bg-center" src="https://c.animaapp.com/miuhpmp5biS0W2/img/a-cardboard-box-with-stickers-on-it-flying-through-the-air-.png" alt="" />
            </div>
            <h1 className="ml-[60%] lg:ml-0  [font-family:'BDO_Grotesk-Bold',Helvetica]  font-bold text-black text-3xl md:text-[70px] tracking-[-1.92px] leading-tight md:leading-[91.2px]">
              Unravel
            </h1>
          </div>
        ...
        <section className="relative w-full bg-gradient-to-b from-white to-[#f4f4f4]">
          <div className="max-w-[1708px] mx-auto px-4 md:px-12">
            ...
            <p className="text-center [font-family:'BDO_Grotesk-Medium',Helvetica] font-medium text-black text-lg md:text-[18px] tracking-[-0.32px] leading-[29px] max-w-[739px] mx-auto mb-16">
            ...
            <div className="lg:flex  gap-6 md:gap-8 items-center">
              <div className="lg:w-[150%]">
                <Card className="w-[100%] bg-white rounded-[10px] border border-[#00000026] shadow-[0px_4px_29px_#0000001a] p-6 md:p-8 mb-4">
                  <CardContent className="p-0">
                    <p className="[font-family:'BDO_Grotesk-Regular',Helvetica] font-normal text-black text-md md:text-lg text-center tracking-[1.00px] leading-6">
                ...
                <Card className="mb-10 lg:mb-0 bg-white rounded-[10px] border border-[#00000026] shadow-[0px_4px_29px_#0000001a] p-6 md:px-1 md:py-6">
                  <CardContent className="">
                    <p className="[font-family:'BDO_Grotesk-Regular',Helvetica] font-normal text-black text-sm md:text-md text-center tracking-[1.00px] leading-6">
              ...
              <div className="relative md:col-span-1 px-15 md:px-0 ">
                <img
                  className="w-full  h-[400px] md:h-[541px] rounded-[30px_30px_0px_0px] md:rounded-[50px_50px_0px_0px] object-cover"
                  alt="Rectangle"
                  src="https://c.animaapp.com/miuhpmp5biS0W2/img/rectangle-261.png"
                />
              </div>

              <p className="mt-5 lg:mt-0 text-center [font-family:'BDO_Grotesk-Black',Helvetica] font-black text-[#2e2e2e] text-2xl md:text-[24px] max-w-[554px] mx-auto md:col-span-3">
          ...
          <div className="  px-5">
            <div className="w-full flex flex-col-reverse md:flex-row justify-between items-center ">
              <div className="md:w-[90%] ">
                <h3 className="[font-family:'BDO_Grotesk-Bold',Helvetica] font-bold text-black text-lg md:text-[20px] tracking-[-0.32px] leading-normal md:leading-[91.2px] mb-4">
                  It's not about ticking boxes.
                </h3>
                <p className="[font-family:'BDO_Grotesk-Medium',Helvetica] font-medium text-black text-base md:text-[20px] tracking-[-0.32px] leading-normal md:leading-[40px] mb-6 md:mb-8">
                ...
                <p className="[font-family:'BDO_Grotesk-Bold',Helvetica] font-bold text-black text-base md:text-[20px] tracking-[-0.32px] leading-normal md:leading-[40px]">
                  We believe in slow mornings, long dinners, and leaving room for the things you didn't plan.
                </p>
              </div>

              <div className="flex justify-center mb-10 md:mt-0 md:justify-end gap-2 md:gap-4 md:w-full">
                <img
                  className=" w-[30%]  lg:h-[537px] rounded-[30px_0px_0px_30px] md:rounded-[50px_0px_0px_50px] object-cover"
                  alt="Rectangle"
                  src="https://c.animaapp.com/miuhpmp5biS0W2/img/rectangle-133.png"
                />
                <img
                  className="w-[30%] h-[300px] md:h-[537px] object-cover"
                  alt="Rectangle"
                  src="https://c.animaapp.com/miuhpmp5biS0W2/img/rectangle-152.png"
                />
                <img
                  className="w-[30%] h-[300px] md:h-[537px] rounded-[0px_30px_30px_0px] md:rounded-[0px_50px_50px_0px] object-cover"
                  alt="Rectangle"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 px-5">
              <Card className="bg-white rounded-[12px] border border-[#00000026] shadow-[0px_4px_29px_#0000001a] py-8 px-10">
                <CardContent className="p-0 flex flex-col items-center text-center">
                  ...
                  <h1 className="text-[40px]/[40px] lg:text-[45px]/[45px] text-[transparent] bg-contain [font-family:'BDO_Grotesk-Bold',Helvetica] font-bold bg-center bg-clip-text  bg-[url(https://c.animaapp.com/miuhpmp5biS0W2/img/we-re-curators.png)]">
                    We're <br /> Curators</h1>
                  <br />
                  <p className="[font-family:'BDO_Grotesk-Medium',Helvetica] text-sm font-medium text-[#393636] md:text-lg tracking-[-0.32px] md:leading-[34px] mb-10 md:mb-14">
                  ...
                  <p className="[font-family:'BDO_Grotesk-Bold',Helvetica] font-bold text-black text-sm md:text-md tracking-[-0.32px] md:leading-[34px]">
              ...
              <Card className="bg-white rounded-[12px] border border-[#00000026] shadow-[0px_4px_29px_#0000001a] py-8 px-10">
                <CardContent className="p-0 flex flex-col items-center text-center">
                  ...
                  <h1 className="text-[40px]/[40px] lg:text-[45px]/[45px]   text-[transparent] bg-contain [font-family:'BDO_Grotesk-Bold',Helvetica] font-bold bg-center bg-clip-text bg-contain  bg-[url(https://c.animaapp.com/miuhpmp5biS0W2/img/not-sellers.png)]">
                    Not <br /> Sellers</h1>

                  <br />

                  <p className="[font-family:'BDO_Grotesk-Medium',Helvetica] font-medium text-[#3a3636] text-sm md:text-lg tracking-[-0.32px] md:leading-[34px] mb-9">
                  ...
                  <p className="[font-family:'BDO_Grotesk-Bold',Helvetica] font-bold text-black md:text-md tracking-[-0.32px] md:leading-[34px]">
        ...
        <section className="relative w-full py-20">
          <div className="max-w-[1708px] mx-auto px-4 md:px-12">
            ...
            <p className="text-center [font-family:'BDO_Grotesk-Medium',Helvetica] font-medium text-black text-lg  tracking-[-0.32px] leading-[45px] mb-8 md:mb-12">
              ...
              <CardContent className="p-0">
                {whatWeDontDoItems.map((item, index) => (
                  <React.Fragment key={index}>
                    <p className="[font-family:'BDO_Grotesk-DemiBold',Helvetica] font-bold text-[#222222] text-sm md:text-md    tracking-[-0.32px] leading-[34px] py-[20px] px-6 md:px-10">
                      {item}
                    </p>
            ...
            <Card className="bg-white rounded-[13px] shadow-[0px_4px_20px_#00000026] max-w-[776px] mx-auto p-8 md:p-12">
              <CardContent className="p-0 flex flex-col items-center justify-center gap-4 md:gap-6">
                <p className="[font-family:'BDO_Grotesk-Medium',Helvetica] font-medium text-[#222222] text-lg md:text-[15px] text-center tracking-[-0.32px] leading-[34px]">
                ...
                <p className="[font-family:'BDO_Grotesk-ExtraBold',Helvetica] font-extrabold text-[#222222] text-lg md:text-[15px] text-center tracking-[-0.32px] leading-[34px]">
        ...
        <section className=" w-full py-20 bg-[#f6f3f0]">
          ...
          <div className=" flex flex-col-reverse md:flex-row justify-around items-center max-w-[1708px] mx-auto px-4 md:px-12 gap-8">
            <div className="w-full md:w-[45%]">
              ...
              <h3 className="[font-family:'BDO_Grotesk-Bold',Helvetica] font-bold text-black text-xl tracking-[-0.32px] md:leading-[80px] mb-4">
                Not every destination makes the cut.
              </h3>


              <div>
                <p className="[font-family:'BDO_Grotesk-Regular',Helvetica] font-normal text-black text-lg  tracking-[-0.32px] md:leading-[40px] mb-6 md:mb-8">
                ...
                <p className="[font-family:'BDO_Grotesk-ExtraBold',Helvetica] font-extrabold text-black text-lg  tracking-[-0.32px] leading-[25px]">
