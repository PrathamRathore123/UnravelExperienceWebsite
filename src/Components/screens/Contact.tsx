...
export const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <section className="relative w-full h-[900px] bg-no-repeat bg-cover overflow-hidden " style={{backgroundImage:"linear-gradient(rgba(0, 0, 0, 0.8),rgba(0, 0, 0, 0.8),rgba(0, 0, 0, 0.8)),url(https://c.animaapp.com/miww62p4QlXFLl/img/rectangle-258.png)"}}>
        <div className="absolute top-[436px] left-1/2 -translate-x-1/2 w-full max-w-[1242px] px-4">
          <h1 className="translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms] text-center [font-family:'BDO_Grotesk-Bold',Helvetica] font-bold text-[#f6f6f6] text-[91.7px] tracking-[-1.92px] leading-[50.2px]">
            Let&#39;s figure this out together
          </h1>
        </div>

        <p className="translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:400ms] absolute top-[567px] left-1/2 -translate-x-1/2 w-full max-w-[850px] px-4 text-center [font-family:'BDO_Grotesk-DemiBold',Helvetica] font-bold text-[#cacaca] text-3xl tracking-[-0.80px] leading-[35px]">
          Whether you know exactly where you&#39;re going or just have a feeling
          you want to chase we&#39;re here.
        </p>

        <div className="translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:600ms] absolute top-[699px] left-1/2 -translate-x-1/2 w-[236px] h-[51px] bg-[#2929297a] rounded-[75px] backdrop-blur-[3px] flex items-center justify-center">
          <span className="[font-family:'BDO_Grotesk-Medium',Helvetica] font-medium text-white text-[21px] tracking-[-0.32px] leading-[30px]">
            Scroll to connect
          </span>
        </div>
      </section>
      ...
      <section className="relative w-full px-4 py-20">
        <div className="max-w-7xl mx-auto">
          <h2 className="translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms] text-center [font-family:'BDO_Grotesk-Bold',Helvetica] font-bold text-black text-[64px] tracking-[0] leading-[50.2px] mb-6">
            Custom Experience Form
          </h2>

          <p className="translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:400ms] text-center [font-family:'BDO_Grotesk-Regular',Helvetica] font-normal text-black text-[32px] tracking-[0] leading-[50.2px] mb-4">
            Design your own journey.
          </p>

          <p className="translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:600ms] text-center [font-family:'BDO_Grotesk-Regular',Helvetica] font-normal text-black text-2xl tracking-[0] leading-[37px] max-w-[634px] mx-auto mb-16">
            Didn&#39;t find what you&#39;re looking for? Tell us what you&#39;re
            imagining, and we&#39;ll build something that fits.
          </p>

          <div className="grid lg:grid-cols-[686px_1fr] gap-0 max-w-[1566px] mx-auto">
            <aside className="bg-[#ebe9e9] rounded-l-[13px] p-12 space-y-12">
              <div className="w-[212px] h-[42px] bg-[url(https://c.animaapp.com/miww62p4QlXFLl/img/untitled-design-7-removebg-preview-png.png)] bg-cover bg-center" />

              <div className="space-y-8">
                <h3 className="[font-family:'BDO_Grotesk-Bold',Helvetica] font-bold text-[#222222] text-[40px] tracking-[-0.32px] leading-[19.6px]">
              ...
              <div className="space-y-8">
                ...
                <p className="[font-family:'BDO_Grotesk-Regular',Helvetica] font-normal text-[21px] tracking-[-0.07px] leading-[30px]">
            ...
            <div className="bg-[#f1f1f1] rounded-r-[13px] p-12  ">
              <div className="">
      ...
      <section className="relative w-full h-[535px] overflow-hidden">
        <img
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full px-4">
          <p className="[font-family:'Roboto_Mono',Helvetica] font-bold text-white text-[25px] tracking-[0.70px] leading-[13.3px] mb-16">
            WE&apos;RE BASED IN
          </p>

          <h2 className="text-center [font-family:'BDO_Grotesk-Bold',Helvetica] font-bold text-white text-[64px] tracking-[-0.88px] leading-[52px] max-w-[1133px]">
            Bangalore, but we work everywhere.
          </h2>
        </div>
      </section>
 <div className="w-[613px] h-[117px] bg-[url(https://c.animaapp.com/miww62p4QlXFLl/img/untitled-design-7-removebg-preview-png-1.png)] bg-cover bg-center" />
