  ...
  <br /><br /><br /><br /><br />
    <div id="start" className="relative w-full bg-white min-h-screen" data-model-id="462:506">
      <div className="w-full">
        {/* Navigation */}
      <h1 className=" block md:hidden [font-family:'BDO_Grotesk-Regular',Helvetica] font-normal text-center text-black text-3xl md:text-[64px] tracking-[-3.50px] leading-tight md:leading-[68px] ">
                {data.title}
              </h1>
        ...
        <section className="flex flex-col lg:flex-row gap-10 container mx-auto px-4 md:px-8 py-12">
          <div className="grid grid-cols-2 gap-3 max-w-[1100px] mx-auto mb-8 lg:mb-16">
            <img
              className="w-full h-[150px] sm:h-[200px] md:h-[250px] md:rounded-tl-[150px] object-cover"
              alt={data.title}
              src={data.heroImages[0]}
            />
            <img
              className="w-full h-[150px] sm:h-[200px] md:h-[250px] object-cover md:rounded-tr-[20px]"
              alt={data.title}
              src={data.heroImages[1]}
            />
            <img
              className="w-full h-[150px] sm:h-[200px] md:h-[250px] object-cover rounded-bl-[75px] md:rounded-bl-[20px]"
              alt={data.title}
              src={data.heroImages[2]}
            />
            <img
              className="w-full h-[150px] sm:h-[200px] md:h-[250px] rounded-br-[75px] object-cover"
              alt={data.title}
              src={data.heroImages[3]}
            />
          </div>

          <div className="max-w-[1200px] md:mx-auto bg">
            <div>
              <h1 className="hidden md:block [font-family:'BDO_Grotesk-Regular',Helvetica] font-normal text-black text-3xl md:text-[64px] tracking-[-3.50px] leading-tight md:leading-[68px] mb-6">
                {data.title}
              </h1>
              <p className="hidden md:block [font-family:'Inter_Variable-Bold',Helvetica] font-bold text-[#9b9b9b] text-base md:text-xl tracking-[-0.32px] leading-[28px] mb-8">
                {data.subtitle}
              </p>
